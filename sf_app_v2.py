...
from sf_utils_v2 import build_image_uploader, get_similar_flowers, interpret_image, classify_image, get_similar_flowers, display_result
...
if __name__ == "__main__":
    ...
    st.subheader("Load a flower picture, our AI will classify it into our categories: [daisy,  roses,  sunflowers,  tulips]")
